...
public class MedicosController {
    ...
    @PostMapping
    public ResponseEntity<DatosRespuestaMedico> registrarMedico(@RequestBody @Valid DatosRegistroMedicos datosRegistroMedicos, UriComponentsBuilder uriComponentsBuilder) {
